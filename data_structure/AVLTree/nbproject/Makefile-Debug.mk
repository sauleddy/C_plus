...
${OBJECTDIR}/_ext/9f3d0cd6/BSTree.o: ../BinarySearchTree/BSTree.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/9f3d0cd6/BSTree.o ../BinarySearchTree/BSTree.cpp
...
${OBJECTDIR}/AVLNode.o: AVLNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AVLNode.o AVLNode.cpp

${OBJECTDIR}/AVLTree.o: AVLTree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AVLTree.o AVLTree.cpp
